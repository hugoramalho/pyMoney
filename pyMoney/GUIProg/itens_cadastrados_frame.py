...
class itens_cadastrados_frame(c_frame_itens_cadastrados):
    ...
    def edit_itemServ(self):
        ...
        item_sel = self.lst_bd.m_item(idd_item_sel)
        top = Toplevel()
        edita_item = edita_item_frame(top, item_sel)
...
class edita_item_frame(insere_itemServ_frame):
    ...
    def __init__(self, framePai, itemServ):
        insere_itemServ_frame.__init__(self, framePai)
        self.item = itemServ
    ...
    def __comando_B3__(self):
        ...
        self.bd_prog.update_itemServ(id_itemServ, tipo = tipo, nome = nome, descr = descr, categ = categ, subcateg = subCateg, marca = marca)
        self.clear_treeView1()
        self.__cond_B3__()
